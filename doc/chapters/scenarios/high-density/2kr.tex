...
the residuals in \secref{subsec:hdassumptions}. Here we will discuss the
results.

\input{scenarios/high-density/2kr/coverage}
\input{scenarios/high-density/2kr/collisions}
\input{scenarios/high-density/2kr/messages}
\input{scenarios/high-density/2kr/time}
